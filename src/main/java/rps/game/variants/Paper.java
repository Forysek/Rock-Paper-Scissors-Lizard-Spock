...
public class Paper implements RockPaperScissors {
    ...
    public Paper(final String name, final String strength1, final String strength2, final String weakness1,
    ...
    public void finishLine(String winningVariant){
        if(winningVariant.equals("Scissors")){
            System.out.println("Scissors cut Paper.");
        } else if(winningVariant.equals("Lizard")){
            System.out.println("Lizard eats Paper.");
        } else {
            System.out.println("Two Papers meet!");
        }
    }
}